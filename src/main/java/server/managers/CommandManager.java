...
public class CommandManager {
    ...
    public CommandManager(CollectionManager collectionManager, ServerSendingManager serverSendingManager, UserManager userManager, SQLManager sqlManager, SpaceMarineComparator comparator) {
    ...
    public void addCommands(){
        ...
        commandMap.put("add", new Add("add", "добавить новый элемент в коллекцию", collectionManager, serverSendingManager, userManager, sqlManager));
        ...
        commandMap.put("clear", new Clear("clear", "очистить коллекцию", collectionManager, serverSendingManager, userManager, sqlManager));
        commandMap.put("group_counting_by_health", new CountingByHealth("group_counting_by_health", "сгруппировать элементы коллекции по значению поля health; вывести количество элементов в каждой группе", serverSendingManager, userManager, sqlManager));
        commandMap.put("add_if_min", new AddIfMin("add_if_min", "добавить новый элемент в коллекцию, если его значение меньше чем у наименьшего элемента этой коллекции", collectionManager, serverSendingManager, userManager, sqlManager));
        commandMap.put("print_ascending", new PrintAscending("print_ascending", "вывести элементы коллекции в порядке возрастания",serverSendingManager, userManager, sqlManager));
        commandMap.put("print_descending", new PrintDescending("print_descending", "вывести элементы коллекции в порядке убывания",serverSendingManager, userManager, sqlManager));
        ...
        commandMap.put("save", new Save("save", "сохранить коллекцию", collectionManager, sqlManager, userManager, serverSendingManager));
    }
